...
bg = image.load("e6903156b1be4273dd3e2329b78a53f3.jpg")
...
cells = [Ball(randint(-2000, 2000), randint(-2000,2000), 10, (randint(50, 220), randint(50, 220), randint(50, 220)))] for _ in range(300)]
